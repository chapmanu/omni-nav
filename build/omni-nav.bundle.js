...
var OmniNav = function () {
  ...
  var buildPrimaryLink = function buildPrimaryLink(label, dropdownMenu) {
  ...
  var buildGlobalDropdown = function buildGlobalDropdown(listItems) {
  ...
  var buildGlobalDropdownItem = function buildGlobalDropdownItem(listItem) {
